...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-blue-700">Ajouter un Nouveau Sac</h1>
        <p class="text-gray-600 mt-1">Créez un nouveau type de sac pour votre boulangerie</p>
    </div>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden p-6">
        <form action="{{ route('bags.store') }}" method="POST">
            ...
            <div class="mb-4">
                <label for="price" class="block text-gray-700 text-sm font-bold mb-2">Prix unitaire (€)</label>
            ...
            <div class="mb-6">
                ...
                <input type="number" name="alert_threshold" id="alert_threshold" value="{{ old('alert_threshold', 100) }}" required min="1"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
