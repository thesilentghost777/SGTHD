		 ...
		 <!-- General Section -->
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('factures.index') }}" class="flex items-center p-2 rounded hover:bg-white/10"><i class="mdi mdi-file-document-outline mr-2"></i>Valider les factures pour les matières prises dans le complexe</a></li>
