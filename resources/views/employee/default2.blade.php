		 ...
		 <!-- General Section -->
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('cashier.index') }}" class="flex items-center p-2 rounded hover:bg-white/10"><i class="mdi mdi-cash-register mr-3 text-blue-200 group-hover:text-white"></i>Gestion de la caisse</a></li>
                    <li><a href="{{ route('versements.index') }}" class="flex items-center p-2 rounded hover:bg-white/10"><i class="mdi mdi-cash-register mr-3 text-blue-200 group-hover:text-white"></i>Versement</a></li>
                    <li><a href="{{ route('factures-complexe.index') }}" class="flex items-center p-2 rounded hover:bg-white/10"><i class="mdi mdi-file-document-outline mr-2"></i>Valider les factures pour les matières prises dans le complexe</a></li>
                    <li><a href="{{ route('matieres.complexe.statistiques') }}" class="flex items-center p-2 rounded hover:bg-white/10"><i class="mdi mdi-file-document-outline mr-2"></i>Statistique des factures pour les matières prises dans le complexe</a></li>
                    <li><a href="{{ route('matieres.complexe.statistiques') }}" class="flex items-center p-2 rounded hover:bg-white/10"><i class="mdi mdi-chart-bar mr-2"></i>Statistiques des factures pour les matières prises dans le complexe</a></li>                    <li><a href="{{ route('manquant.mes-deductions') }}" class="flex items-center p-2 rounded hover:bg-white/10"><i class="mdi mdi-alert-circle mr-2"></i>Montant a deduire au salaire</a></li>
