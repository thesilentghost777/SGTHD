        ...
        <div class="mt-6 space-y-8">
		 ...
		 <!-- General Section -->
            <div>
                ...
                <ul class="space-y-2">
                    @if (auth()->user()->role == 'gestionnaire_alimentation')
                    ...
                    @endif
                    <li><a href="{{ route('inventory.groups.index') }}" class="flex items-center p-2 rounded hover:bg-white/10"><i class="mdi mdi-package-variant mr-2"></i>Calculateur de manquant</a></li>
