...
<html><head><base href="https://www.thmarket.sn">
  <meta charset="UTF-8">
  ...
  <body>
    ...
    <nav id="nav3">
      <ul>
        <li class="separateur"><a href="{{ route('login') }}">Connexion</a></li>
        <li class="separateur"><a href="{{ route('register') }}">Enregistrement</a></li>
      </ul>
    </nav>
