    ...
    <aside
        ...
        <div class="mt-6 space-y-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="{{ route('producteur.workspace') }}" class="flex items-center p-2 rounded hover:bg-white/10"><i class="mdi mdi-clipboard-text mr-2"></i>Produits du jour</a></li>
                    ...
                    <li class="flex items-center p-2 rounded hover:bg-white/10 cursor-pointer">
                        <a href="{{ route('assignations.mes-assignations') }}">
                            <i class="mdi mdi-clipboard-list-outline mr-2"></i>Matières Assignées
                        </a>
                    </li>
                    <li class="flex items-center p-2 rounded hover:bg-white/10 cursor-pointer">
                    ...
                    <li class="flex items-center p-2 rounded hover:bg-white/10 cursor-pointer">
                        <a href="{{ route('factures-complexe.index') }}">
                            <i class="mdi mdi-clipboard-list-outline mr-2"></i>Afficher les factures
                        </a>
                    </li>

                    <li class="flex items-center p-2 rounded hover:bg-white/10 cursor-pointer">
                        <a href="{{ route('taules.inutilisees.index') }}">
                            <i class="mdi mdi-clipboard-list-outline mr-2"></i>Recuperation de Matieres
                        </a>
                    </li>
