    ...
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-8">
                ...
                <p class="mt-2 text-gray-600">Remplissez les informations ci-dessous pour enregistrer une nouvelle production</p>
            </div>
                ...
                <form action="{{ route('utilisations.store') }}" method="POST" id="productionForm" class="divide-y divide-gray-200">
                    ...
                    <div class="p-6">
                        <div class="mb-4">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Ajoutez les matières premières nécessaires pour cette production</p>
                        </div>
