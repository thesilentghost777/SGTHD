...
class ServeurController extends Controller
{
   ...
   public function store(Request $request){
    ...
    public function ajouterProduit_recu(){
        ...
        $heure_actuelle->setTimezone('UTC');
        $nom = $employe->name;
      return view('pages/serveur/serveur-ajouterProduit_recu',compact('Employe','produitR','heure_actuelle','nom'));
    }
    ...
    public function enrProduit_vendu(){
        ...
        $heure_actuelle->setTimezone('UTC');
        $nom = $employe->name;
        return view('pages/serveur/serveurepr',compact('produitR','heure_actuelle','nom'));
    }
    public function store_invendu(Request $request){
        ...
        if (!$employe) {
          return redirect()->route('login')->with('error', 'Veuillez vous connecter');
            ...
            $heure_actuelle->setTimezone('UTC');
            $nom = $employe->name;
            return view('pages/serveur/serveur-produit_invendu',compact('produitR','heure_actuelle','nom'));
        }
        ...
        if (!$employe) {
          return redirect()->route('login')->with('error', 'Veuillez vous connecter');
            ...
            $heure_actuelle->setTimezone('UTC');
            $nom = $employe->name;
            return view('pages/serveur/serveur-versement',compact('versement','heure_actuelle','nom'));
        }
